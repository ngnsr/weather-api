...
export class CreateEntities1747517760235 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "subscriptions" ("id" SERIAL NOT NULL, "frequency" "public"."subscriptions_frequency_enum" NOT NULL, "city" character varying NOT NULL, "is_confirmed" boolean NOT NULL DEFAULT false, "confirmation_token_expires_at" date, "is_unsubscribed" boolean NOT NULL DEFAULT false, is_active boolean generated always as (is_confirmed AND NOT is_unsubscribed) stored, "confirmation_token" uuid NOT NULL DEFAULT uuid_generate_v4(), "unsubscribe_token" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer NOT NULL, CONSTRAINT "UQ_db406d6dd916761071a50954c10" UNIQUE ("user_id", "city"), CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
